...
listScroll = tkinter.Scrollbar(mainWindow, orient=tkinter.HORIZONTAL, command=fileList.xview)
listScroll.grid(row=1, column=0, sticky='swe', rowspan=2)
fileList['xscrollcommand'] = listScroll.set
