...
if __name__ == '__main__':
    ...
    with open('html_file.html', 'w') as html_file_doc:
        my_page.display(file=html_file_doc)

# using aggregation in place of composition
new_body = Body()
...
with open('html_file1.html', 'w') as html_file_doc:
    my_page.display(file=html_file_doc)
